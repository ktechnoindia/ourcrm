...
export class ViewPurchasereturnPage implements OnInit {
  ...
  constructor(private excelService: ExcelService,private router:Router,private toastCtrl:ToastController,private purchasereturnservice:PurchasereturnService,private encService:EncryptionService ) { 
    const compid='1';
