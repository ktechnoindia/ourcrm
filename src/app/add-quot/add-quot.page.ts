...
export class AddQuotPage implements OnInit {
  ...
  grossrate : string ='';
    ...
    selectGst: number = 0;
    selectGst$: any;
  constructor(private router: Router,private unittype: UnitnameService,private gstsrvs:GsttypeService, private toastCtrl: ToastController, private quote: QuotationService) {
