...
export const environment = {
  ...
  deletecust: 'masters/dcustomer',
  getlang: 'lang',
  toasttiming: 2000,
  deleteCustomer: 'masters/dcustomer',
  deleteVendor: 'masters/dvendor',
  deleteItem: 'masters/ditem',
  deleteExecutive: 'masters/dexecutive',
  deleteLedger: 'masters/dlegder',
